...
gulp.task("scripts", function () {
    return gulp.src([
        ...
        .pipe(gulp.dest('../wp-content/themes/artuplugins/js/'))
        .pipe(browserSync.reload({ stream: true }));
});
...
gulp.task('styles', function () {
    return gulp.src([
        ...
        .pipe(sourcemaps.write('.'))
        .pipe(gulp.dest('../wp-content/themes/artuplugins/css/'))
        .pipe(browserSync.reload({ stream: true }));
});
...
gulp.task("libsjs", function () {
    return gulp.src([
        ...
        // "node_modules/nouislider/distribute/nouislider.min.js",//npm i nouislider
...
gulp.task('img', function() {
    return gulp.src('src/img/**')
        .pipe(gulp.dest('../wp-content/themes/artuplugins/img/'));
});
